  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd("ColorScheme", {
      ...
      callback = function()
        ...
        vim.api.nvim_set_hl(0, "@markup.heading.1.markdown", { fg = srcery_bright_red, bold = true })
        vim.api.nvim_set_hl(0, "@markup.heading.2.markdown", { fg = srcery_bright_orange, bold = true })
        ...
        vim.api.nvim_set_hl(0, "markdownH1", { fg = srcery_bright_red, bold = true })
        vim.api.nvim_set_hl(0, "markdownH2", { fg = srcery_bright_orange, bold = true })
        ...
        vim.api.nvim_set_hl(0, "RenderMarkdownH1Bg", { fg = srcery_bright_red })
        vim.api.nvim_set_hl(0, "RenderMarkdownH2Bg", { fg = srcery_bright_orange })
